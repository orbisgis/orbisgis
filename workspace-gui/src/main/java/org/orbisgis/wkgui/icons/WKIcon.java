 ...
 */
package org.orbisgis.wkgui.icons;
 ...
 */
public final class WKIcon {
    private static BaseIcon iconManager = new BaseIcon(LoggerFactory.getLogger(WKIcon.class));
    ...
    public static Image getIconImage(String iconName) { 
        return iconManager.getIconImage(WKIcon.class, iconName);
    }
    /**
    ...
    public static ImageIcon getIcon(String iconName) {
        return iconManager.getIcon(WKIcon.class, iconName);
    }
}
