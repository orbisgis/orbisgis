...
public class TableEditorPlugIn extends ViewPlugIn implements IEditor {
    ...
    public void initialize(PlugInContext context) {
        ...
        if (context.getWorkbenchContext().getWorkbench().getFrame().getViewDecorator(Names.EDITOR_TABLE_ID) == null) {
            context.getWorkbenchContext().getWorkbench().getFrame().getViews().add(
