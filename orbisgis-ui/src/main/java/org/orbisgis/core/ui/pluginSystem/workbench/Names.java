...
public abstract class Names {
    ...
    // Edit SE Legend
    public static final String POPUP_TOC_FEATURETYPESTYLE_EDIT = I18N
			.getString("orbisgis.ui.popupmenu.TOC.featureTypeStype.edit");
    public static final String POPUP_TOC_FEATURETYPESTYLE_IMPORT = I18N
			.getString("orbisgis.ui.popupmenu.TOC.featureTypeStype.import");
    public static final String POPUP_TOC_FEATURETYPESTYLE_EXPORT = I18N
			.getString("orbisgis.ui.popupmenu.TOC.featureTypeStype.export");
    public static final String POPUP_TOC_FEATURETYPESTYLE_EDIT_RULE = I18N
			.getString("orbisgis.ui.popupmenu.TOC.featureTypeStype.rule.edit");
    public static final String POPUP_TOC_FEATURETYPE_STYLE_WIZARDS = I18N
			.getString("orbisgis.ui.popupmenu.TOC.featureTypeStype.wizards");


	// Create SE Legend with Wizard
    public static final String POPUP_TOC_FEATURETYPESTYLE_CREATE_CHOROPLETH = I18N
			.getString("orbisgis.ui.popupmenu.TOC.featureTypeStype.rule.choroWizard");
