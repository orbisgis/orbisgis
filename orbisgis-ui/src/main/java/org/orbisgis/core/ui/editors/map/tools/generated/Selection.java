...
public abstract class Selection implements Automaton {
	...
	public String getMessage() {
		...
		if ("Standby".equals(status)) {
			return I18N.getString("orbisgis.core.ui.editors.map.tool.selection_standby");
		}
		...
		if ("OnePointLeft".equals(status)) {
			return I18N.getString("org.orbisgis.core.ui.editors.map.tool.selection_onepointleft");
		}
		...
		if ("Selection".equals(status)) {
			return I18N.getString("orbisgis.core.ui.editors.map.tool.selection_selection");
		}
		...
		if ("Movement".equals(status)) {
			return I18N.getString("orbisgis.core.ui.editors.map.tool.selection_movement");
		}
	...
	public String getTooltip() {
		return I18N.getString("orbisgis.core.ui.editors.map.tool.selection_tooltip");
	}
