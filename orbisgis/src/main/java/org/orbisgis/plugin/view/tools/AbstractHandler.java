...
public abstract class AbstractHandler implements Handler {
     ...
     */
    protected Coordinate[] removeVertex(int vertexIndex, com.vividsolutions.jts.geom.Geometry g, int minNumVertex) throws CannotChangeGeometryException {
        Coordinate[] coords = g.getCoordinates();
        if (coords.length <= minNumVertex) {
            throw new CannotChangeGeometryException("Una geometra no puede tener tan pocos vrtices");
        }
