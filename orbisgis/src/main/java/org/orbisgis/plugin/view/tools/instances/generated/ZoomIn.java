...
public abstract class ZoomIn implements Automaton {
	...
	public URL getIconURL() {
		return this.getClass().getResource("/org/orbisgis/plugin/view/tools/instances/generated/zoomIn.png");
	}

	public URL getMouseCursorURL() {
		
		return this.getClass().getResource("/org/orbisgis/plugin/view/tools/instances/generated/zoomInCursor.gif");
