...
public class GrapContrastAdjuster extends JPanel implements 
	...
	public GrapContrastAdjuster(GeoRaster georaster) {
	...
	public void initialise() {
		...
		thread = new Thread( "ContrastAdjuster");
	...
	void setup(GeoRaster georaster) {
		ImagePlus imp = null;
		try {
