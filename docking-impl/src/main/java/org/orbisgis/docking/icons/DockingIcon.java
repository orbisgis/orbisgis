 ...
 */
package org.orbisgis.docking.icons;
 ...
 */
public final class DockingIcon {
    private static BaseIcon iconManager = new BaseIcon(LoggerFactory.getLogger(DockingIcon.class));
    ...
    public static Image getIconImage(String iconName) { 
        return iconManager.getIconImage(DockingIcon.class, iconName);
    }
    /**
    ...
    public static ImageIcon getIcon(String iconName) {
        return iconManager.getIcon(DockingIcon.class, iconName);
    }
}
