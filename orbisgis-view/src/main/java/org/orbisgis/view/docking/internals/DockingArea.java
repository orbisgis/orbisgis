...
public class DockingArea {
    private DockingAreaParameters parameters = new DockingAreaParameters();
    private CWorkingArea workingArea;

    public DockingArea(CWorkingArea workingArea) {
        this.workingArea = workingArea;
    }

    public DockingAreaParameters getParameters() {
        return parameters;
    }
