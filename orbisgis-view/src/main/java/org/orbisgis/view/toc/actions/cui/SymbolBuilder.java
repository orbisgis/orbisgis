...
//import org.orbisgis.sif.AskValue;
import org.orbisgis.view.toc.actions.cui.components.Canvas;
import org.orbisgis.view.toc.actions.cui.components.SymbolCollection;
import org.orbisgis.view.toc.actions.cui.components.SymbolSelection;
...
public class SymbolBuilder extends JPanel implements UIPanel,
        ...
        private static final I18n I18N = I18nFactory.getI18n(SymbolBuilder.class);
        private static Logger LOGGER = Logger.getLogger("gui."+SymbolBuilder.class);
	private final class NoSuitableEditor implements ISymbolEditor {
		...
		public Component getComponent() {
			return new JLabel(I18N.tr("No suitable editor"));
		}
...
//		canvasPreview.add(canvas);
	...
	private JPanel getRightPanel() {
		...
		jButtonSymbolUp.setIcon(OrbisGISIcon.getIcon("go-up"));
		jButtonSymbolUp.setToolTipText(I18N.tr("Up")); 
		...
		jButtonSymbolDown.setIcon(OrbisGISIcon.getIcon("go-down"));
		jButtonSymbolDown.setToolTipText(I18N.tr("Down")); 
		...
		jButtonSymbolAdd.setIcon(OrbisGISIcon.getIcon("add"));
		jButtonSymbolAdd.setToolTipText(I18N.tr("Add")); 
		...
		jButtonSymbolDel.setIcon(OrbisGISIcon.getIcon("del"));
		jButtonSymbolDel.setToolTipText(I18N.tr("Delete")); 
		...
		jButtonSymbolRename.setIcon(OrbisGISIcon.getIcon("pencil"));
		jButtonSymbolRename.setToolTipText(I18N.tr("Rename")); 
		...
		btnToCollection.setIcon(OrbisGISIcon.getIcon("save"));
		btnToCollection.setToolTipText(I18N.tr("Save")); 
		...
		btnFromCollection.setIcon(OrbisGISIcon.getIcon("add"));
		btnFromCollection.setToolTipText(I18N.tr("Add")); 
	...
	private void jList1ValueChanged() {
		...
		if ((model.getSize() > 0) && (index != -1)) {
			...
			if (selected != null) {
				...
				LOGGER.error(I18N.tr("No suitable editor for this legend"));
			}
...
//		AskValue ask = new AskValue(I18N.tr("Insert the new name"), "txt is not null",
//				I18N.tr("A name must be specified"), selectedSymbol.getName());
		String new_name = "new Symbol"+System.currentTimeMillis();
...
//				getSymbolComposite());
//		JOptionPane.showMessageDialog(this, I18N.tr("Symbol saved in geocognition"));
	}
	...
	public String validateInput() {
		if (lstSymbols.getModel().getSize() == 0) {
			return I18N.tr("At least a symbol must be created");
		}
