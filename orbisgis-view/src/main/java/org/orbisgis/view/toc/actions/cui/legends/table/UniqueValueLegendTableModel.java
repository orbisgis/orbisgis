 ...
 */
package org.orbisgis.view.toc.actions.cui.legends.table;
...
public class UniqueValueLegendTableModel extends ClassifiedLegendTableModel
	...
	private static Logger UILOGGER = Logger
			.getLogger("gui."+UniqueValueLegendTableModel.class);
	...
	public void setValueAt(Object value, int rowIndex, int columnIndex) {
		UILOGGER.error("Setting value in classified legend: " + value + ". at "
