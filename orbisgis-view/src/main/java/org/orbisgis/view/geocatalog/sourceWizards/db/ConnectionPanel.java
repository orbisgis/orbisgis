...
public class ConnectionPanel extends MultiInputPanel {
        ...
        public ConnectionPanel(SourceManager sourceManager) {
                super("orbisgis.view.geocatalog.sourceWizards.db.FirstUIPanel", I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.connect"));
                this.sourceManager = sourceManager;
                setInfoText(I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.connectionParameters"));
                addInput(DBTYPE, I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.dbType"),
                        getDriverInput());
                addValidationExpression(DBTYPE + " is not null", I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.dbTypeChooser"));
                addInput(HOST, I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.hostName"),
                        "127.0.0.1", new StringType(LENGTH));
                addValidationExpression(HOST + " is not null", I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.hostNameChooser"));
                addInput(PORT, I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.portNumberDefault"),
                        "0", new IntType(LENGTH));

                addValidationExpression("(" + PORT + " >= 0) and (" + PORT
                        + " <= 32767)", I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.portNumber"));
                addInput(DBNAME, I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.dbName"),
                        "database_name", new StringType(LENGTH));
                addValidationExpression(DBNAME + " is not null", I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.dbNameMandatory"));
                addInput(USER, I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.userName"),
                        "postgres", new StringType(LENGTH));
                addInput(PASSWORD, I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.password"), "",
                        new PasswordType(LENGTH));

                addInput(SSL, I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.ssl"), new CheckBoxChoice(false));
        }
        ...
        public String postProcess() {
                try {
                        ...
                        return I18N.getString("orbisgis.view.geocatalog.sourceWizards.db.cannotConnect") + ": " + e.getMessage();
                }
        }
