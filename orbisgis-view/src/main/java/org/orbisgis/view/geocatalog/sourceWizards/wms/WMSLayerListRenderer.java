...
public class WMSLayerListRenderer extends ListLaFRenderer {
    ...
    /**
     * Associates this renderer to the given JList.
     *
     * @param list The list that will use this as a renderer.
     */
    public WMSLayerListRenderer(JList list) {
        super(list);
    }
    ...
    public Component getListCellRendererComponent(JList list, Object value,
        ...
        if (cellRenderer instanceof JLabel) {
            ...
            MapLayer listItem = (MapLayer) value;
            JLabel label = (JLabel) cellRenderer;
            label.setText(listItem.getName());
        }
        return cellRenderer;
    }
}
