package org.orbisgis.view.components.file;
...
public class FileDrop {
        ...
        /**
         * Constructs a {@link FileDrop} with a default light-blue border and,
         * if <var>c</var> is a {@link java.awt.Container}, recursively sets all
         ...
         * will also listen for drops, though only the parent will change
         * borders. With Debugging turned on, more status messages will be
        ...
        /**
         * Constructor with a specified border and debugging optionally turned
         * on. With Debugging turned on, more status messages will be displayed
         * to <tt>out</tt>. A common way to use this constructor is with
         * <tt>System.out</tt> or <tt>System.err</tt>. A <tt>null</tt> value for
         * the parameter <tt>out</tt> will result in no debugging output.
         *
         * @param out PrintStream to record debugging info or null for no
         ...
         * components after you've set up the drag-and-drop. This will
         * recursively unregister all components contained within <var>c</var>
         * if <var>c</var> is a {@link java.awt.Container}.
         *
        ...
        public interface Listener {
                ...
                /**
                 * This method is called when files have been successfully
                 * dropped.
                 *
