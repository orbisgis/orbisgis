 ...
 */
public class TableNumberColumnRenderer extends TableLaFCellRenderer {
        private JFormattedTextField formatedField = new JFormattedTextField();
        
        public TableNumberColumnRenderer(JTable table) {
                super(table, Number.class);
        ...
        public Component getTableCellRendererComponent(JTable jtable, Object o, boolean bln, boolean bln1, int i, int i1) {
                Component lafComp = lookAndFeelRenderer.getTableCellRendererComponent(jtable, o, bln, bln1, i, i1);
