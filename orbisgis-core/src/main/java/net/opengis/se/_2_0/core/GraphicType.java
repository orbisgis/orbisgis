...
@XmlSeeAlso({
    CompositeGraphicType.class,
    GraphicReferenceType.class,
    ExternalGraphicType.class,
    AlternativeGraphicsType.class,
    PointTextGraphicType.class,
    MarkGraphicType.class,
    PieChartType.class,
    AxisChartType.class
})
