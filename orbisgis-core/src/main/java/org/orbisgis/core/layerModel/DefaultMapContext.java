...
public class DefaultMapContext implements MapContext {
                                ...
                                for (final ILayer layer : e.getAffected()) {
                                        try {
                                                ...
                                                Services.getErrorManager().error(
                                                        I18N.getString("orbisgis.org.orbisgis.defaultMapContext.cannotOpenLayer") + layer.getName() //$NON-NLS-1$
                                                        + I18N.getString("orbisgis.org.orbisgis.defaultMapContext.layerRemovedFromView"), //$NON-NLS-1$
                                                        ex);
                                                try {
                                                        layer.getParent().remove(layer);
                                                } catch (LayerException e1) {
                                                        Services.getErrorManager().error(
                                                                I18N.getString("orbisgis.org.orbisgis.defaultMapContext.cannotRemoveLayer") + layer.getName(), //$NON-NLS-1$
                                                                ex);
                                                }
                                        }
                                }
                                ...
                                if (isOpen()) {
                                        try {
                                                ...
                                                Services.getErrorManager().warning(
                                                        I18N.getString("orbisgis.org.orbisgis.defaultMapContext.cannotCloseLayer") + layer.getName(), e1); //$NON-NLS-1$
                                        }
                                }
                        }
        ...
        public ILayer recoverTree(LayerType layer,
                ...
                if (layer instanceof LayerCollectionType) {
                        ...
                        for (LayerType layerType : xmlChildren) {
                                ...
                                if (lyr != null) {
                                        try {
                                                ...
                                                Services.getErrorManager().error(
                                                        I18N.getString("orbisgis.org.orbisgis.defaultMapContext.cannotAddLayerToCollection") //$NON-NLS-1$
                                                        + lyr.getName(), e);
                                        }
                                }
                        }
                        ...
                        try {
                                ...
                                Services.getErrorManager().error(
                                        I18N.getString("orbisgis.org.orbisgis.defaultMapContext.cannotRecoverLayer") + layer.getName(), e); //$NON-NLS-1$
                        }
                }
                return ret;
        }
        ...
        private void checkIsOpen() {
                if (!isOpen()) {
                        throw new IllegalStateException(
                                I18N.getString("orbisgis.core.ui.plugins.views.geocognition.wizards.newMap")); //$NON-NLS-1$
                }
        }
        ...
        public void setJAXBObject(Object jaxbObject) {
                if (isOpen()) {
                        throw new IllegalStateException(
                                I18N.getString("orbisgis.org.orbisgis.defaultMapContext.theMapMust") //$NON-NLS-1$
                                + I18N.getString("orbisgis.org.orbisgis.defaultMapContext.beClosedToInvokeThisMethod")); //$NON-NLS-1$
                }
                ...
                for (int i = 0; i < layers.length; i++) {
                        ...
                        if (!layers[i].acceptsChilds()) {
                                try {
                                        ...
                                        Services.getErrorManager().error(
                                                I18N.getString("orbisgis.org.orbisgis.defaultMapContext.cannotCloseLayer") + layers[i].getName()); //$NON-NLS-1$
                                }
                        }
                }
                this.root.removeLayerListenerRecursively(openerListener);
        ...
        public void open(ProgressMonitor pm) throws LayerException {
                ...
                if (isOpen()) {
                        throw new IllegalStateException(
                                I18N.getString("orbisgis.org.orbisgis.defaultMapContext.mapAlreadyOpen")); //$NON-NLS-1$
                }
                ...
                if (jaxbMapContext != null) {
                        ...
                        try {
                                ...
                                Services.getErrorManager().error(
                                        I18N.getString("orbisgis.org.orbisgis.defaultMapContext.cannotReadBoundingBox"), e); //$NON-NLS-1$
                        }
                        /*
                                ...
                                if (!layers[i].acceptsChilds()) {
                                        try {
                                                ...
                                                Services.getService(ErrorManager.class).warning(
                                                        I18N.getString("orbisgis.org.orbisgis.defaultMapContext.cannotOpen") + layers[i].getName() //$NON-NLS-1$
                                                        + I18N.getString("orbisgis.org.orbisgis.defaultMapContext.layerIsRemoved"), e); //$NON-NLS-1$
                                ...
                                if (layerPersistenceMap != null) {
                                        if (!toRemove.contains(layers[i])) {
                                                try {
                                                        ...
                                                        Services.getService(ErrorManager.class).warning(
                                                                I18N.getString("orbisgis.org.orbisgis.defaultMapContext.cannotRestore") + layers[i].getName() //$NON-NLS-1$
                                                                + I18N.getString("orbisgis.org.orbisgis.defaultMapContext.layerIsRemoved"), e); //$NON-NLS-1$
                                                        toRemove.add(layers[i]);
                                                }
                                        }
                ...
                public void action(ILayer layer) {
                        ...
                        if (resourceNames.contains(layerName)) {
                                try {
                                        ...
                                        Services.getErrorManager().error(
                                                I18N.getString("orbisgis.org.orbisgis.defaultMapContext.cannotAssociateLayer") + layer.getName() //$NON-NLS-1$
                                                + I18N.getString("orbisgis.org.orbisgis.defaultMapContext.layerMustRemovedManually")); //$NON-NLS-1$
                                }
                        }
                }
        }
