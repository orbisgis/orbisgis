...
public abstract class GdmsLayer extends AbstractLayer {
	...
	public void addLayer(ILayer layer) {
		throw new IllegalArgumentException(I18N.getString("orbisgis-core.org.orbisgis.layerModel.gdmsLayer.layerCannotHaveChildren")); //$NON-NLS-1$
	}

	public ILayer remove(ILayer layer) {
		throw new IllegalArgumentException(I18N.getString("orbisgis-core.org.orbisgis.layerModel.gdmsLayer.layerCannotDoesntChildren")); //$NON-NLS-1$
	}
	...
	public ILayer getLayer(final int index) {
		throw new ArrayIndexOutOfBoundsException(
				I18N.getString("orbisgis-core.org.orbisgis.layerModel.gdmsLayer.layerDoesntContainAnyChild")); //$NON-NLS-1$
	}
