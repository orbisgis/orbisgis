...
public abstract class Multipolygon implements Automaton {
	...
	public String[] getTransitionLabels() {
		...
		if ("Standby".equals(status)) {
			...
			ret.add(I18N.getText("org.orbisgis.core.ui.editors.map.tool.multipolygon_standby_to_done"));
		...
		if ("Point".equals(status)) {
			...
			ret.add(I18N.getText("org.orbisgis.core.ui.editors.map.tool.multipolygon_point_to_line"));

			ret.add(I18N.getText("org.orbisgis.core.ui.editors.map.tool.multipolygon_point_to_done"));
	...
	public String getMessage() {
		...
		if ("Standby".equals(status)) {
			return I18N.getText("org.orbisgis.core.ui.editors.map.tool.multipolygon_standby");
		}

		if ("Point".equals(status)) {
			return I18N.getText("org.orbisgis.core.ui.editors.map.tool.multipolygon_point");
		}
	...
	public String getTooltip() {
		return I18N.getText("org.orbisgis.core.ui.editors.map.tool.multipolygon_tooltip");
	}
