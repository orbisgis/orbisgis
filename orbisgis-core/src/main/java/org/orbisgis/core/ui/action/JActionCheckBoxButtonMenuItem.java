...
public class JActionCheckBoxButtonMenuItem extends JCheckBoxMenuItem implements
	...
	public JActionCheckBoxButtonMenuItem(String text, String group, String id,
		...
		this.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				JActionCheckBoxButtonMenuItem.this.action.actionPerformed();
