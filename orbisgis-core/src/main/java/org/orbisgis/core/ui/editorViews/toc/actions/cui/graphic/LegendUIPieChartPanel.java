...
public class LegendUIPieChartPanel extends LegendUIComponent implements LegendUIGraphicComponent, SliceListener {
    ...
    protected void mountComponent() {
		...
		JButton btnAdd = new JButton(OrbisGISIcon.ADD);
