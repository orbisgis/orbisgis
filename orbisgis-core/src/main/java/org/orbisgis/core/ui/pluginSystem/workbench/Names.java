...
public abstract class Names {
	...
	public static final String EXIT = I18N
			.getText("orbisgis.ui.menu.file.text.exit");
	// Save
	public static final String SAVE = I18N
			.getText("orbisgis.ui.menu.file.text.save");
	// Change Workspace
	public static final String CHANGE_WS = I18N
			.getText("orbisgis.ui.menu.file.text.changeWorkspace");
	// Save Workspace
	...
	public static final String POPUP_TABLE_DELETEFIELD_OPTION = I18N
			.getText("orbisgis.ui.popupmenu.table.deleteField.option");
	public static final String POPUP_TABLE_REMOVEFIELD_OPTION = I18N
			.getText("orbisgis.ui.popupmenu.table.removeField.option");
