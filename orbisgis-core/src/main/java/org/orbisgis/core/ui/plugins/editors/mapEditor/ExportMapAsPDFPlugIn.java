...
public class ExportMapAsPDFPlugIn extends AbstractPlugIn {
    ...
    public boolean execute(PlugInContext context) throws Exception {
        ...
        ScaleEditor scaleEditor = new ScaleEditor(mapEditor.getMapTransform().getScaleDenominator());
    ...
    public void save(File outputFile, Scale scale, BufferedImage img,
        ...
        try {
            if (outputFile.getName().toLowerCase().endsWith("pdf")) { //$NON-NLS-1$
                ...
                Renderer r = new PdfRenderer(templateMap, pageWidth, pageHeight);

                r.draw(g2dMap,(int) pageWidth, (int)pageHeight, envelope, layer,
                ...
                g2dLegend.drawString(
                        I18N.getString("orbisgis.org.orbisgis.ui.map.exportMapAsPDFPlugIn.legend"), 0, 10); //$NON-NLS-1$
                ...
                JOptionPane.showMessageDialog(null, I18N.getString("orbisgis.core.file.fileSaved")); //$NON-NLS-1$
            }
