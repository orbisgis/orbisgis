...
public class WorkspacePanel extends JPanel implements ItemListener {
	...
	private static final String TIMER_LABEL = "Timer (Minutes)";
	private static final String TIMER_GROUP = "Save Workspace";
	private static final String TIMER_CHECK = "Enable Saving";
