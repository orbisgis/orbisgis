...
import org.orbisgis.core.ui.views.geocatalog.newSourceWizard.EPSourceWizardHelper;
import org.orbisgis.core.ui.views.geocatalog.persistence.ActiveFilter;
import org.orbisgis.core.ui.views.geocatalog.persistence.Tag;
...
public class CatalogView implements IView {
		...
		if (catalogFile.exists()) {
			try {
				JAXBContext jc = JAXBContext.newInstance(
						"org.orbisgis.core.ui.views.geocatalog.persistence",
						EPWindowHelper.class.getClassLoader());
				org.orbisgis.core.ui.views.geocatalog.persistence.Catalog cat = (org.orbisgis.core.ui.views.geocatalog.persistence.Catalog) jc
	...
	public void saveStatus() throws PersistenceException {
		org.orbisgis.core.ui.views.geocatalog.persistence.Catalog cat = new org.orbisgis.core.ui.views.geocatalog.persistence.Catalog();
