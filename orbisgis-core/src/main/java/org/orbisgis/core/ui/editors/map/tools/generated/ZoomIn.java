...
public abstract class ZoomIn implements Automaton {
	...
	public String getMessage() {
		...
		if ("Standby".equals(status)) {
			return I18N.getText("org.orbisgis.core.ui.editors.map.tool.zoomin_standby");
		}

		if ("OnePointLeft".equals(status)) {
			return I18N.getText("org.orbisgis.core.ui.editors.map.tool.zoomin_onepointleft");
		}
	...
	public String getTooltip() {
		return I18N.getText("org.orbisgis.core.ui.editors.map.tool.zoomin_tooltip");
	}
