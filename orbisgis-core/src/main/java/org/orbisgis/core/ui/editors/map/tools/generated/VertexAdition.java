...
public abstract class VertexAdition implements Automaton {
	...
	public String getMessage() {
		...
		if ("Standby".equals(status)) {
			return I18N.getText("org.orbisgis.core.ui.editors.map.tool.vertexAdition_standby");
		}
	...
	public String getTooltip() {
		return I18N.getText("org.orbisgis.core.ui.editors.map.tool.vertexAdition_tooltip");
	}
