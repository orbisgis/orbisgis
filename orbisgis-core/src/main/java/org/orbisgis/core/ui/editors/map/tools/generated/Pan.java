...
public abstract class Pan implements Automaton {
	...
	public abstract void transitionTo_RectangleDone(MapContext vc, ToolManager tm) throws FinishedAutomatonException, TransitionException;
	public abstract void drawIn_RectangleDone(Graphics g, MapContext vc, ToolManager tm) throws DrawingException;
