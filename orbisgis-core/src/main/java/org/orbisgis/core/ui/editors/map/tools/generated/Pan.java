...
public abstract class Pan implements Automaton {
	...
	public String getMessage() {
		...
		if ("Standby".equals(status)) {
			return I18N.getText("org.orbisgis.core.ui.editors.map.tool.pan_standby");
		}

		if ("OnePointLeft".equals(status)) {
			return I18N.getText("org.orbisgis.core.ui.editors.map.tool.pan_onepointleft");
		}
	...
	public String getTooltip() {
		return I18N.getText("org.orbisgis.core.ui.editors.map.tool.pan_tooltip");
	}
