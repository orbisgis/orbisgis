...
public class PolygonCentroidHalfCircleLeftSymbol extends AbstractHalfCirclePointSymbol {

	PolygonCentroidHalfCircleLeftSymbol(Color outline, int lineWidth, Color fillColor,
	...
	public Symbol cloneSymbol() {
		return new PolygonCentroidHalfCircleLeftSymbol(outline, lineWidth, fillColor,
				size, mapUnits);
	}
	...
	public Symbol deriveSymbol(Color color) {
		return new PolygonCentroidHalfCircleLeftSymbol(color.darker(), lineWidth, color
