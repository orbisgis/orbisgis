...
public class HalfCircleRightVertexSymbol extends HalfCircleRightPointSymbol {
	...
	HalfCircleRightVertexSymbol(Color outline, int lineWidth, Color fillColor, int size,
			boolean mapUnits) {
	...
	public StandardSymbol cloneSymbol() {
		return new HalfCircleRightVertexSymbol(outline, lineWidth, fillColor, size,
				mapUnits);
	}

	public String getId() {
		return "org.orbisgis.symbol.vertex.HalfCircleRigth";
	}
