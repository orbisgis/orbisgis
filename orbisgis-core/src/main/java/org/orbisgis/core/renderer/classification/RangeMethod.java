...
public class RangeMethod {
         ...
         */
        public static String QUANTILE_METHOD = "Quantiles", JENKS_METHOD = "Jenks",
                EQUALS_METHOD = "Equivalences", MEAN_METHOD = "Moyennes", STANDARD_METHOD = "Standard";

        /**
         * 
         * @param ds the input data
         * @param fieldName the column that contains the value to be classified
         * @param nbCl the number of classes
