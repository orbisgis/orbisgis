...
public class HalfCircleRightPointSymbol extends AbstractHalfCirclePointSymbol {
	...
	HalfCircleRightPointSymbol(Color outline, int lineWidth, Color fillColor,
	...
	public Envelope draw(Graphics2D g, Geometry geom, MapTransform mt,
		...
		while (!pi.isDone()) {
			...
			paintHalfCircle(g, (int) coords[0], (int) coords[1], drawingSize,
					-90, 180);
			pi.next();
		}
	...
	public String getClassName() {
		return "Half circle right in point";
	}
	...
	public String getId() {
		return "org.orbisgis.symbol.point.HalfCircleRight";
	}

	@Override
	public Symbol deriveSymbol(Color color) {
		return new HalfCircleRightPointSymbol(color.darker(), lineWidth, color
