 ...
 */
package org.orbisgis.plugins.core.layerModel;
...
import org.orbisgis.plugins.core.layerModel.persistence.LayerCollectionType;
import org.orbisgis.plugins.core.layerModel.persistence.LayerType;
import org.orbisgis.plugins.core.layerModel.persistence.SelectedLayer;
import org.orbisgis.plugins.core.renderer.Renderer;
...
public class DefaultMapContext implements MapContext {
	...
	private org.orbisgis.plugins.core.layerModel.persistence.MapContext jaxbMapContext;
	...
	public Object getJAXBObject() {
		if (jaxbMapContext != null) {
			...
			org.orbisgis.plugins.core.layerModel.persistence.MapContext xmlMapContext = new org.orbisgis.plugins.core.layerModel.persistence.MapContext();
	...
	public void setJAXBObject(Object jaxbObject) {
		...
		org.orbisgis.plugins.core.layerModel.persistence.MapContext mapContext = (org.orbisgis.plugins.core.layerModel.persistence.MapContext) jaxbObject;
	...
	public void close(IProgressMonitor pm) {
		...
		jaxbMapContext = (org.orbisgis.plugins.core.layerModel.persistence.MapContext) getJAXBObject();
	...
	private final class DeleteLayerFromResourceAction implements
			org.orbisgis.plugins.core.layerModel.ILayerAction {
