...
import org.orbisgis.plugins.core.renderer.classification.RangeMethod;
import org.orbisgis.plugins.core.renderer.legend.Legend;
import org.orbisgis.plugins.core.renderer.legend.carto.Interval;
import org.orbisgis.plugins.core.renderer.legend.carto.IntervalLegend;
...
import org.orbisgis.plugins.core.ui.editorViews.toc.actions.cui.legends.table.IntervalLegendTableModel;
...
public class PnlIntervalLegend extends PnlAbstractClassifiedLegend {
	...
	protected JPanel getTopPanel() {
		...
		cmbIntervalType
				.setModel(new DefaultComboBoxModel(new Object[] { "Quantiles",
						"Equivalences", "Moyennes", "Standard", "Jenks" }));
