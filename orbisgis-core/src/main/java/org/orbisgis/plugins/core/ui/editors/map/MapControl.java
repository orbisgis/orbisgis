 ...
 */
package org.orbisgis.plugins.core.ui.editors.map;
...
import org.orbisgis.plugins.core.background.DefaultJobId;
...
import org.orbisgis.plugins.core.ui.editors.map.tool.ToolListener;
	...
	public class Drawer implements BackgroundJob {
		...
		public void run(IProgressMonitor pm) {
			...
			try {
				...
				wbContext.setLastAction("Set Element");
				...
				WorkbenchContext wbContext = Services
						.getService(WorkbenchContext.class);
				wbContext.setLastAction("Repaint Map");
			}
		}
