...
import org.orbisgis.plugins.core.ui.views.geocatalog.newSourceWizards.wms.LayerConfigurationPanel;
import org.orbisgis.plugins.core.ui.views.geocatalog.newSourceWizards.wms.SRSPanel;
import org.orbisgis.plugins.core.ui.views.geocatalog.newSourceWizards.wms.WMSConnectionPanel;
...
public class WMSGeocatalogPlugIn extends AbstractPlugIn {
	...
	public void initialize(PlugInContext context) throws Exception {
		...
		context.getFeatureInstaller().addPopupMenuItem(
				...
				getIcon(Names.POPUP_GEOCATALOG_WMS_ICON), wbContext);
	}
