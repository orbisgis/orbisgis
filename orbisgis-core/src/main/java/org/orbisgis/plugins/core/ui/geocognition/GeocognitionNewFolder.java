...
public class GeocognitionNewFolder extends AbstractPlugIn {

	public boolean execute(PlugInContext context) throws Exception {
		getUpdateFactory().executeGeocognitionElement(new NewFolder());
		return true;
	}
	...
	public void initialize(PlugInContext context) throws Exception {
		...
		context.getFeatureInstaller().addPopupMenuItem(
				...
				new String[] { Names.POPUP_GEOCOGNITION_ADD,
						Names.POPUP_GEOCOGNITION_ADD_FOLDER_PATH1 },
				Names.POPUP_GEOCOGNITION_ADD_FOLDER_GROUP, false,
				getIcon(Names.POPUP_GEOCOGNITION_ADD_FOLDER_ICON), wbContext);
	}
