...
import org.orbisgis.plugins.core.geocognition.sql.GeocognitionBuiltInFunction;
...
public class GeocognitionRegisterBuiltInFunction extends AbstractPlugIn {
	...
	public void initialize(PlugInContext context) throws Exception {
		...
		context.getFeatureInstaller().addPopupMenuItem(frame, this,
				...
				getIcon(Names.POPUP_GEOCOGNITION_REG_BUILT_ICON), wbContext);
	}
