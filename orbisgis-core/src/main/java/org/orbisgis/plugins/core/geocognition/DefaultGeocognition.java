...
import org.orbisgis.plugins.core.geocognition.persistence.GeocognitionNode;
import org.orbisgis.plugins.core.geocognition.persistence.NodeContent;
...
public class DefaultGeocognition implements Geocognition {
	...
	public static String getCognitionContextPath() {
		return "org.orbisgis.plugins.core.geocognition.persistence";
	}
}
