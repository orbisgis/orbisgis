...
import org.orbisgis.plugins.core.ui.views.geocatalog.newSourceWizards.xyzdem.ConvertXYZDEMWizard;
...
public class ConvertXYZDemGeocatalogPlugIn extends AbstractPlugIn {
	...
	public void initialize(PlugInContext context) throws Exception {
		...
		context.getFeatureInstaller().addPopupMenuItem(
				...
				getIcon(Names.POPUP_GEOCATALOG_CONVERT_XYZ_ICON), wbContext);
	}
