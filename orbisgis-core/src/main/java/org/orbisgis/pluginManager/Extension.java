 ...
 *    thomas.leduc _at_ cerma.archi.fr
	...
	Some part imported from gearscape a fork of OrbisGIS.
 */
...
public class Extension {
	...
	public Extension(String xml, String point, String id, PluginInfo pluginInfo) {
		super();
		this.xml = xml;
		this.point = point;
		this.id = id;
	...
	public Configuration getConfiguration() {
		try {
			return new Configuration(xml, pluginInfo.getPluginClassLoader());
