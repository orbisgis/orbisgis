 ...
 *
    Part of this code has been imported from GEARSCAOE a fork of OrbisGIS.
 *
...
public class Configuration {
	...
	public Object instantiateFromAttribute(String xpath, String attribute) {
		...
		try {
			...
			throw new RuntimeException("Cannot find the class " + className, e);
		...
		public InputStream getResourceAsStream(String xpath, String attribute) {
		String resourceName;
		try {
			resourceName = vtd.getAttribute(xpath, attribute);
