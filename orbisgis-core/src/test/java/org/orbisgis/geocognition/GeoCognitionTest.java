...
public class GeoCognitionTest extends AbstractGeocognitionTest {
	...
	public void testJavaFunctionPersistence() throws Exception {
		String codeContent = "the function java code here";
		FunctionJavaCode code = new FunctionJavaCode(codeContent);
		gc.addElement("org.myfunction", code);
		saveAndLoad();
		FunctionJavaCode readCode = gc.getElement("org.myfunction",
				FunctionJavaCode.class);
	...
	public void testJavaCustomQueryPersistence() throws Exception {
		String codeContent = "the custom query java code here";
		CustomQueryJavaCode code = new CustomQueryJavaCode(codeContent);
	...
	public void testClone() throws Exception {
		gc.addFolder("folder1");
		gc.addElement("/folder1/id1", new DefaultMapContext());
		gc.addElement("/folder1/Buffer", Buffer.class);
		gc.addElement("/folder1/register", RegisterCall.class);
		gc.addElement("/folder1/id4", new FunctionJavaCode(
		...
		GeocognitionElement folder2 = folder1.cloneElement();
		folder1.addElement(folder2);
		ByteArrayOutputStream bos2 = new ByteArrayOutputStream();
		gc.write(bos2, "/folder1/folder1");

		assertTrue(new String(bos1.toByteArray()).equals(new String(bos2
				.toByteArray())));
	}
	...
	public void testChangeNameChangesCode() throws Exception {
		String script = "package org.orbisgis;" + "public class B {"
				+ "public String getName(){" + "return \"B\";}}";
		gc.addElement("B", new FunctionJavaCode(script));
		GeocognitionElement element = gc.getGeocognitionElement("B");
		element.setId("A");
