...
public class Triangle extends com.vividsolutions.jts.geom.Triangle {
   ...
   * @param c2 The third coordinate.
   */
  public Triangle(final Coordinate c0, final Coordinate c1, final Coordinate c2) {
    super(c0, c1, c2);
  ...
  public boolean contains(final Coordinate coordinate) {
    ...
    int p0p1Orientation = CGAlgorithms.computeOrientation(p0, p1, coordinate);
    if (p0p1Orientation != triangleOrientation
      && p0p1Orientation != CGAlgorithms.COLLINEAR) {
      return false;
    }
    int p1p2Orientation = CGAlgorithms.computeOrientation(p1, p2, coordinate);
    if (p1p2Orientation != triangleOrientation
      && p1p2Orientation != CGAlgorithms.COLLINEAR) {
      return false;
    }
    int p2p0Orientation = CGAlgorithms.computeOrientation(p2, p0, coordinate);
