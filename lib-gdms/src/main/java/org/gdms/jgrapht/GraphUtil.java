...
public class GraphUtil {
    ...
    */
    public static boolean isGraphConnected(Collection features, boolean dim3) {
        Graph<INode,Geometry> g = GraphFactory.createGraph(features, dim3);
        return new ConnectivityInspector((UndirectedGraph<INode,Geometry>)g)
                   .isGraphConnected();
    }
    ...
    */
    public static List getVertices(Collection features, int minDegree, int maxDegree, boolean dim3) {
        ...
        UndirectedGraph<INode,Geometry> g =
            (UndirectedGraph<INode,Geometry>)GraphFactory.createGraph(features, dim3);
    ...
    */
    ...
    public static Geometry createPoint(Graph graph, GNode node1, GNode node2, double pr, double distaxe) {
        ...
        // Coordonn�e du noeud correspondant au PR pr�c�dent
        ...
        // D�calage perpendiculairement � l'axe
