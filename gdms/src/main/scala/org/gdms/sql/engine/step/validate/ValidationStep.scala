 ...
 * info@orbisgis.org
 */
package org.gdms.sql.engine.step.validate
 ...
 * Step 5: Validation.
 * 
 * All Operation instances validate everything that can be validated without accessing the DSF. Same for
 * Expression instances (preValidate).
 */
