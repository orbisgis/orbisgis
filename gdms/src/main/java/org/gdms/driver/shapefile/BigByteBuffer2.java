...
public class BigByteBuffer2 {
	...
	private synchronized ByteBuffer mapFrom(long newPos) throws IOException {
		...
		fc.read(bb);
		bb.position(0);
		// System.out.println("Mapeo desde " + newPos + " con sizeChunk= " +
		// sizeChunk + " numRead = " + numRead);
		minAbs = newPos;
	...
	public BigByteBuffer2(FileChannel fc, FileChannel.MapMode mode,
			long amountMem) throws IOException {
