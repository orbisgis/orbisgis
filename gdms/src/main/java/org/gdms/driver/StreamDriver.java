...
public interface StreamDriver extends Driver {
    /**
        * Opens the stream. <code>seturl</code> must have been called before calling <code>open</code>.
        *
    ...
    /**
        ...
        * Doit-on garder ou adapter cette méthode ?
        * 
        * @return
        */
    ...
    /**
        ...
        * Faut-il créer un objet url qui s'assure de la validité et de l'accessibilité d'une url ?
