...
public final class SQLEngine {
        ...
        /**
         * Creates a new SQLEngine with the given <code>DataSourceFactory</code>
         * @param dsf a DataSourceFactory
         */
        public SQLEngine(DataSourceFactory dsf) {
                this.dsf = dsf;
        }
         ...
         */
        public SQLEngine(DataSourceFactory dsf, Properties properties) {
                this.dsf = dsf;
