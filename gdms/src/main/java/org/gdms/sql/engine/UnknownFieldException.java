...
public final class UnknownFieldException extends SemanticException {
    ...
    /**
     * Constructs an instance of <code>UnknownFieldException</code> with the specified detail message.
    ...
    public UnknownFieldException(String msg) {
        ...
        public String getMessage() {
                return String.format("The field %s does not exist.", super.getMessage());
        }
}
