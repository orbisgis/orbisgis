...
public class AddColumnOperator extends AbstractOperator implements Operator {
	...
	public AddColumnOperator(DataSourceFactory dsf, String tableName,
	...
	protected ObjectDriver getResultContents(IProgressMonitor pm)
		...
		try {
			...
			ds.addField(columnName, getTypeFromSQLEngineConstants(columnType));
			ds.commit();
			ds.close();
