 ...
 */
public final class ToDegrees extends AbstractScalarMathFunction {
	...
	public Value evaluate(DataSourceFactory dsf, Value... args)
		...
		if (args[0].isNull()) {
			...
			return ValueFactory.createValue(Math.toDegrees(args[0]
					.getAsDouble()));
		}
	}
	...
	public String getSqlOrder() {
		return "select ToDegrees(myNumericField) from myTable;";
	}
