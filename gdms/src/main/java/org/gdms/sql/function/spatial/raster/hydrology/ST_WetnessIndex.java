 ...
 */
public final class ST_WetnessIndex extends AbstractScalarRasterFunction {
        ...
        public Value evaluate(DataSourceFactory dsf, Value... args) throws FunctionException {
                ...
                final Operation operation = new WetnessIndexOp(grAccflow);
                try {
        ...
        public String getDescription() {
                return "Compute the Wetness index using a slopes grid in radian and a accumulation grid";
        }

        @Override
        public String getName() {
                return "ST_WetnessIndex";
        }

        @Override
        public String getSqlOrder() {
                return "select ST_WetnessIndex(a.raster,b.raster ) as raster from slopes as a, acc as b;";
        }
