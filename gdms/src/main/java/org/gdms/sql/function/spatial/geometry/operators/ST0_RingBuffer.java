...
public class ST0_RingBuffer extends AbstractSpatialFunction {
	...
	public String getName() {
		return "STO_RingBuffer";
	}

	public Arguments[] getFunctionArguments() {
		return new Arguments[] {
				new Arguments(Argument.GEOMETRY, Argument.NUMERIC, Argument.INT),
	...
	public Geometry getBuffers(Geometry geom, double bufferDistance,
		...
		return gf.createGeometryCollection(buffers.toArray(new Geometry[0]));
	...
	public String getSqlOrder() {
		return "select STO_RingBuffer(the_geom, bufferSize, ringNumbers[, 'butt'|'square'|'round']) from myTable;";
	}
