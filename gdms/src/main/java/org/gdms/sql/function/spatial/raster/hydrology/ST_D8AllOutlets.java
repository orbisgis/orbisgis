...
/**
 * Compute all the watershed outlets using a GRAY16/32 DEM slopes directions
 * as input table
 */
public final class ST_D8AllOutlets extends AbstractScalarRasterFunction {
        ...
        public Value evaluate(DataSourceFactory dsf, Value[] args) throws FunctionException {
                ...
                try {
                        return ValueFactory.createValue(geoRasterSrc.doOperation(allOutlets));
        ...
        public String getSqlOrder() {
                return "select ST_D8Outlet(raster) as raster from direction;";
        }
}
