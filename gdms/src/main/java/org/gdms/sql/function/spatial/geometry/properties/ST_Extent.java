...
/**
 * Return the extent of the specified geometry
 */
public final class ST_Extent extends AbstractSpatialPropertyFunction {
        ...
        public String getDescription() {
                return "Return the extent of the specified geometry";
        }
