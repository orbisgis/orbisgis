 ...
 */
package org.gdms.sql.function.spatial.geometry.edition;
...
public class STO_AddZFromRaster implements Function {
	...
	public String getName() {
		return "STO_AddZFromRaster";
	}

	public String getSqlOrder() {
		return "select STO_AddZFromRaster(b.the_geom, d.raster) from buildings b, dem d;";
	}
