...
public class PercentileCalculator{
     ...
     * with no quantile argument -- use median value (50) as default*/
    private double quantile = 50.0;

    /**
     * Constructs a PercentileCalculator with a default quantile
     * value of 50.0.
     */
    ...
    /**
     * See {@link PercentileCalculator#evaluate(double[], int, int, double)} for a description of the percentile estimation
     * algorithm used.
     * 
    ...
    public static void main(String args[]){
    	...
    	System.out.println(Math.round(new PercentileCalculator().evaluate(vals, 75)));
    }
