 ...
 */
public final class ToRadians extends AbstractScalarMathFunction {
	...
	public Value evaluate(DataSourceFactory dsf, Value[] args)
		...
		if (args[0].isNull()) {
			...
			return ValueFactory.createValue(Math.toRadians(args[0]
					.getAsDouble()));
		}
	}
	...
	public String getSqlOrder() {
		return "select ToRadians(myNumericField) from myTable;";
	}
