...
/**
 * Return true if the geometry A is equal to the geometry B
 */
public final class ST_Equals extends AbstractSpatialPredicateFunction implements
        ...
        public Value evaluateResult(DataSourceFactory dsf, Value... args) throws FunctionException {
                ...
                return ValueFactory.createValue(geom1.equals(geom2));
        }
        ...
        public String getDescription() {
                return "Return true if the geometry A is equal to the geometry B";
        }
