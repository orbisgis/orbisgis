 ...
 */
public final class ST_D8Accumulation extends AbstractScalarRasterFunction {
        ...
        public Value evaluate(DataSourceFactory dsf, Value[] args) throws FunctionException {
                ...
                try {
                        GeoRaster grResut = geoRasterSrc.doOperation(slopesAccumulations);
        ...
        public String getName() {
                return "ST_D8Accumulation";
        }

        @Override
        public String getSqlOrder() {
                return "select ST_D8Accumulation(raster) as raster from direction;";
        }
}
