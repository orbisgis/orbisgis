...
public class ST_Contains extends AbstractSpatialPredicateFunction implements TwoOverlappingArgumentsFunction {
	...
	public Value evaluateResult(final Value[] args) throws FunctionException {
		...
		return ValueFactory.createValue(geom1.contains(geom2));
	}
