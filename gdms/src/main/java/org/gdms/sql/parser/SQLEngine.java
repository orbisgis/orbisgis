...
public class SQLEngine/* @bgen(jjtree) */implements SQLEngineTreeConstants,
		SQLEngineConstants {/* @bgen(jjtree) */
	protected JJTSQLEngineState jjtree = new JJTSQLEngineState();

	public static void main(String[] args) throws ParseException,
			TokenMgrError, FileNotFoundException {
	...
	final public void SQLBetweenClause() throws ParseException {
		...
		ASTSQLBetweenClause jjtn000 = new ASTSQLBetweenClause(
				JJTSQLBETWEENCLAUSE);
		boolean jjtc000 = true;
		jjtree.openNodeScope(jjtn000);
		jjtreeOpenNodeScope(jjtn000);
	...
	final public void SQLCompareExprRight() throws ParseException {
		...
		ASTSQLCompareExprRight jjtn000 = new ASTSQLCompareExprRight(
				JJTSQLCOMPAREEXPRRIGHT);
		boolean jjtc000 = true;
		jjtree.openNodeScope(jjtn000);
		jjtreeOpenNodeScope(jjtn000);
		try {
	...
	final public void SQLLeftJoinClause() throws ParseException {
		...
		ASTSQLLeftJoinClause jjtn000 = new ASTSQLLeftJoinClause(
				JJTSQLLEFTJOINCLAUSE);
		boolean jjtc000 = true;
		jjtree.openNodeScope(jjtn000);
		jjtreeOpenNodeScope(jjtn000);
		try {
	...
	final public void SQLOrderDirection() throws ParseException {
		...
		ASTSQLOrderDirection jjtn000 = new ASTSQLOrderDirection(
				JJTSQLORDERDIRECTION);
		boolean jjtc000 = true;
		jjtree.openNodeScope(jjtn000);
		jjtreeOpenNodeScope(jjtn000);
		try {
	...
	final public void SQLRightJoinClause() throws ParseException {
		...
		ASTSQLRightJoinClause jjtn000 = new ASTSQLRightJoinClause(
				JJTSQLRIGHTJOINCLAUSE);
		boolean jjtc000 = true;
		jjtree.openNodeScope(jjtn000);
		jjtreeOpenNodeScope(jjtn000);
		try {
	...
	final public void SQLUpdateAssignment() throws ParseException {
		...
		ASTSQLUpdateAssignment jjtn000 = new ASTSQLUpdateAssignment(
				JJTSQLUPDATEASSIGNMENT);
		boolean jjtc000 = true;
		jjtree.openNodeScope(jjtn000);
		jjtreeOpenNodeScope(jjtn000);
		try {
	...
	final public void SQLLValueElement() throws ParseException {
		...
		ASTSQLLValueElement jjtn000 = new ASTSQLLValueElement(
				JJTSQLLVALUEELEMENT);
		boolean jjtc000 = true;
		jjtree.openNodeScope(jjtn000);
		jjtreeOpenNodeScope(jjtn000);
