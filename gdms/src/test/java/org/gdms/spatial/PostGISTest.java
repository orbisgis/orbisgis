...
//		try {
//			s
//					.execute("DROP TABLE nueva;delete from geometry_columns where f_table_name = 'nueva';");
...
//		d.insertEmptyRow();
//		d.setFieldValue(0, 1, ValueFactory.createValue(gf.createPoint(new Coordinate(0, 0))));
