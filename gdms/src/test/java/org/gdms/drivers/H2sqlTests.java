...
public class H2sqlTests {
	 ...
	 */
	public static void main(String[] args) throws ClassNotFoundException, SQLException, DriverException, FreeingResourcesException, NonEditableDataSourceException, DriverLoadException, NoSuchTableException, DataSourceCreationException {
	...
	public static  void createH2db () throws ClassNotFoundException, SQLException{
            ...
            st.execute("CREATE TABLE matable (id INTEGER, nom VARCHAR(10), prenom VARCHAR(10),  PRIMARY KEY(id))");
            int k=0;
            for (int i=0; i<10000;i++){
            	
            	 k = i++;
            	
            st.execute("INSERT INTO matable VALUES("+k+", 'erwan', 'bocher')");
