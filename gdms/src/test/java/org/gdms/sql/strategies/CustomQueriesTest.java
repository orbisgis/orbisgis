...
public class CustomQueriesTest extends TestCase {
	...
	public void testRegister() throws Exception {
		...
		String path = SourceTest.internalData + "points.shp";
	...
	public void testFunctionQueryCollission() throws Exception {
		...
		try {
			FunctionManager.addFunction(new ST_Buffer() {
	...
	public void testFunctionRegister() throws Exception {
		dsf
				.executeSQL("SELECT FunctionRegister('org.gdms.sql.strategies.SumQuery2');");
		DataSource d = dsf
				.getDataSourceFromSQL("select sumquery2('gid') from ds;");
