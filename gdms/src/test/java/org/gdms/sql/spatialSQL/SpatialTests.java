...
public class SpatialTests {
	...
	public static void main(String[] args) throws Exception {
		...
		File src2 = new File("../../datas2tests/shp/mediumshape2D/landcover2000.shp");
	...
	private static void testIntersection(SpatialDataSourceDecorator sds, SpatialDataSourceDecorator sds2) throws Exception {
		
				
		String sqlQuery = "select Intersection("+ds1Name+".the_geom,"+ ds2Name+".the_geom) from "
				+ ds1Name + ", "+ ds2Name + ";";
	...
	private static void testContains(SpatialDataSourceDecorator sds1, SpatialDataSourceDecorator sds2) throws SyntaxException, DriverLoadException, NoSuchTableException, ExecutionException, DriverException {
		
		String sqlQuery = "select * from "
		+ ds1Name + ", "+ ds2Name + " where Contains(" +ds1Name+".the_geom,"+ ds2Name+".the_geom)"+ ";";
	...
	public static void displayGeometry (SpatialDataSource spatialds2) throws DriverException {
