...
public class AllTypesObjectDriver implements ObjectDriver {
    ...
    private String[] names = new String[]{"binary", "boolean",
    		"byte", "date", "double", "float", "int", "long", "short", "string", "timestamp", "time"};
    private int[] types = new int[]{Value.BINARY, Value.BOOLEAN, Value.BYTE,
            Value.DATE, Value.DOUBLE, Value.FLOAT, Value.INT, Value.LONG, Value.SHORT,
            Value.STRING, Value.TIMESTAMP, Value.TIME};
    ...
    public AllTypesObjectDriver() throws ParseException{
        ...
        values[0][10] = ValueFactory.createValue(Timestamp.valueOf("1980-9-5 10:30:00.666666666"));
        ...
        values[1][10] = ValueFactory.createValue(Timestamp.valueOf("1984-9-5 10:30:00.666666666"));
