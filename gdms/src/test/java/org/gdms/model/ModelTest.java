...
public class ModelTest extends TestCase {
	...
	public String path = "../../data/shp/basic/linestring.shp";
	...
	public void testMetadata() throws Exception {
		...
		assertTrue(featureCollectionDecorator.size() == sds.getRowCount());
	...
	public void testSaveAsDatasource() throws Exception {
		...
		FeatureCollectionDecorator featureCollectionDecorator = new FeatureCollectionDecorator(
				mydata);
		File gdmsFile = new File("/tmp/saveAsGDMS.gdms");
	...
	public void testgetRowFromValue() throws Exception {
		...
		DataSource mydata = dsf.getDataSource(new File("/home/bocher/data/BD_Topo_Nantes_shp/BATI_surface.shp"));
		...
		System.out.println("PK : "+ sds.getPK(100));

		sds.getRows(sds.getFieldIndexByName("LAYER"), ValueFactory.createValue("REG_BAT"));

		sds.getRows(sds.getFieldIndexByName("LAYER"), ValueFactory.createValue("ADMIN"));

		System.out.println("Result in  " + (Calendar.getInstance().getTimeInMillis()-start));
