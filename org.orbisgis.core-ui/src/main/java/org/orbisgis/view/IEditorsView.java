...
/**
 * Special view that manages/shows all the IEditor instances of the system
 *
 * @author Fernando Gonzalez Cortes
 *
 */
public interface IEditorsView extends IView {

	/**
	 * Gets a decorator on the last selected editor
	 *
	 * @return
	 */
	EditorDecorator getActiveEditor();
