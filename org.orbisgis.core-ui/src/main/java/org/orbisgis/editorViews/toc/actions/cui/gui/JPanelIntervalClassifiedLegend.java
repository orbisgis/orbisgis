...
import org.orbisgis.renderer.legend.carto.DefaultIntervalLegend;
...
public class JPanelIntervalClassifiedLegend extends javax.swing.JPanel
	 ...
	 *
	 * @param leg
	 *            The IntervalClassifiedLegend object.
	 * @param constraint
	 *            The Geometry type of the layer
	 * @param layer
	 *            The ILayer object of the selected layer.
	 */
	...
	/**
	 * When any data of the table changes we update the external legend by the
	 * decorator.
	 *
	 * @param e
	 */
	...
	private void initComponents() {
		...
		jComboBoxClasificationField.setMinimumSize(new java.awt.Dimension(200,
				19));
		...
		jComboBoxTypeOfInterval
				.setPreferredSize(new java.awt.Dimension(100, 19));
		jComboBoxTypeOfInterval
				.addActionListener(new java.awt.event.ActionListener() {
					public void actionPerformed(java.awt.event.ActionEvent evt) {
	...
	protected Symbol createSymbol(Integer constraint, Color fillColor) {
		...
		if (constraint != null) {
			...
			default:
				...
				Symbol sp = createSymbol(GeometryConstraint.POLYGON, fillColor);
				Symbol[] arraySym = { sl, sc, sp };
			...
			Symbol sl = createSymbol(GeometryConstraint.LINESTRING, fillColor);
			Symbol sc = createSymbol(GeometryConstraint.POINT, fillColor);
			Symbol sp = createSymbol(GeometryConstraint.POLYGON, fillColor);
			Symbol[] arraySym = { sl, sc, sp };
	...
	/**
	 * This event is fired when the CB Rest of Values is pressed. It creates a
	 * new Row with a default value or deletes the previous created.
	 *
	 * @param evt
	 */
