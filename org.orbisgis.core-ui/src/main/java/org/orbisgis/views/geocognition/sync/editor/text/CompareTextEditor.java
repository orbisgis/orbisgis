...
public class CompareTextEditor extends JPanel implements ICompareEditor {
	// TODO find icons
	private static final Icon ALL_TO_LEFT = IconLoader.getIcon("add.png");
	private static final Icon ALL_TO_RIGHT = IconLoader.getIcon("add.png");
	private static final Icon SELECTED_TO_LEFT = IconLoader.getIcon("add.png");
	private static final Icon SELECTED_TO_RIGHT = IconLoader.getIcon("add.png");
	private static final Icon SAVE_LEFT = IconLoader.getIcon("add.png");
	private static final Icon SAVE_RIGHT = IconLoader.getIcon("add.png");
	...
	private GeocognitionElementDecorator originalLeft, originalRight;
		...
		scrollbar.addAdjustmentListener(new AdjustmentListener() {
			public void adjustmentValueChanged(AdjustmentEvent e) {
				if (!scrollBarChangeByCode) {
					Point mapping = map.get(e.getValue());
	...
	public void saveLeft() {
		try {
			originalLeft.setXMLContent(leftText);
			leftSavedText = leftText;
			update();
		} catch (GeocognitionException e) {
			Services.getErrorManager().error(
	...
	public void saveRight() {
		try {
			originalRight.setXMLContent(rightText);
			rightSavedText = rightText;
			update();
		} catch (GeocognitionException e) {
			Services.getErrorManager().error(
	...
	private class RightElementListener implements GeocognitionElementListener {
		private void fireChange() {
			try {
				String original = originalRight.getXMLContent();
	...
	private class LeftElementListener implements GeocognitionElementListener {
		private void fireChange() {
			try {
				String original = originalLeft.getXMLContent();
