 ...
 */
package org.orbisgis.mapeditor.map.icons;
...
public class MapEditorIcons {
    ...
    public static Image getIconImage(String iconName) { 
        return iconManager.getIconImage(MapEditorIcons.class, iconName);
    }
    /**
    ...
    public static ImageIcon getIcon(String iconName) {
        return iconManager.getIcon(MapEditorIcons.class, iconName);        
    }
