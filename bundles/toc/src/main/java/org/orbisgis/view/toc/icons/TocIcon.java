 ...
 * Icon files are placed in the resource package org.orbisgis.view.toc.icons
 */
public class TocIcon {
    
    
    private static BaseIcon iconManager = new BaseIcon(LoggerFactory.getLogger(TocIcon.class));
    ...
    public static Image getIconImage(String iconName) { 
        return iconManager.getIconImage(TocIcon.class, iconName);
    }
    /**
    ...
    public static ImageIcon getIcon(String iconName) {
        return iconManager.getIcon(TocIcon.class, iconName);        
    }
