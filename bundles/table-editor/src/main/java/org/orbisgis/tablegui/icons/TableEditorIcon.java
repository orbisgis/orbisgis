 ...
 */
package org.orbisgis.tablegui.icons;
...
public final class TableEditorIcon {
    ...
    public static Image getIconImage(String iconName) { 
        return iconManager.getIconImage(TableEditorIcon.class, iconName);
    }
    /**
    ...
    public static ImageIcon getIcon(String iconName) {
        return iconManager.getIcon(TableEditorIcon.class, iconName);
    }
}
