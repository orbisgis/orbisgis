    ...
    public SortJob(SortKey sortRequest, String columnSortName, DataSourceTableModel tableModel, Collection<Integer> modelIndex, DataSource dataSource) {
        ...
        protected Collection<Integer> doInBackground() throws SQLException {
            ...
            try(Connection connection = dataSource.getConnection()) {
                return ReadTable.getSortedColumnRowIndex(connection,model.getRowSet(), model.getTableName(), columnSortName, sortRequest.getSortOrder() == SortOrder.ASCENDING, this.getProgressMonitor());
            }
        }
