...
/**
 * Abstract class of the plugin which declares the scripts to add, their locations in the process tree and the icons
 * associated. This class contains all tha basic methods.
 ...
 *
 */
public abstract class AbstractWpsScriptsPlugin {
     ...
     */
    protected List<Object> listIdProcess;
    ...
    protected void recursiveScriptLoad(String nodePath, String folderPath, String[] iconArrayName){
        ...
        while(enumUrl.hasMoreElements()){
            try {
                ...
                LoggerFactory.getLogger(AbstractWpsScriptsPlugin.class).error(e.getMessage());
            }
        }
    }
