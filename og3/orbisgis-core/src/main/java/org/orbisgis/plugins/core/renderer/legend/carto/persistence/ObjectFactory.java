 ...
 * org.orbisgis.core.renderer.legend.carto.persistence package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _UniqueSymbolLegend_QNAME = new QName(
			"org.orbisgis.legend", "unique-symbol-legend");
	private final static QName _IntervalLegend_QNAME = new QName(
			"org.orbisgis.legend", "interval-legend");
	private final static QName _UniqueValueLegend_QNAME = new QName(
			"org.orbisgis.legend", "unique-value-legend");
	private final static QName _ProportionalLegend_QNAME = new QName(
			"org.orbisgis.legend", "proportional-legend");
	private final static QName _RasterLegend_QNAME = new QName(
			"org.orbisgis.legend", "raster-legend");
	private final static QName _LabelLegend_QNAME = new QName(
			"org.orbisgis.legend", "label-legend");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package:
	 * org.orbisgis.core.renderer.legend.carto.persistence
	 * 
	 */
	 ...
	 * {@link UniqueSymbolLegendType }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "org.orbisgis.legend", name = "unique-symbol-legend")
	public JAXBElement<UniqueSymbolLegendType> createUniqueSymbolLegend(
			UniqueSymbolLegendType value) {
		return new JAXBElement<UniqueSymbolLegendType>(
				_UniqueSymbolLegend_QNAME, UniqueSymbolLegendType.class, null,
				value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link IntervalLegendType }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "org.orbisgis.legend", name = "interval-legend")
	public JAXBElement<IntervalLegendType> createIntervalLegend(
			IntervalLegendType value) {
		return new JAXBElement<IntervalLegendType>(_IntervalLegend_QNAME,
				IntervalLegendType.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link UniqueValueLegendType }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "org.orbisgis.legend", name = "unique-value-legend")
	public JAXBElement<UniqueValueLegendType> createUniqueValueLegend(
			UniqueValueLegendType value) {
		return new JAXBElement<UniqueValueLegendType>(_UniqueValueLegend_QNAME,
				UniqueValueLegendType.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link ProportionalLegendType }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "org.orbisgis.legend", name = "proportional-legend")
	public JAXBElement<ProportionalLegendType> createProportionalLegend(
			ProportionalLegendType value) {
		return new JAXBElement<ProportionalLegendType>(
				_ProportionalLegend_QNAME, ProportionalLegendType.class, null,
				value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link RasterLegendType }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "org.orbisgis.legend", name = "raster-legend")
	public JAXBElement<RasterLegendType> createRasterLegend(
			RasterLegendType value) {
		return new JAXBElement<RasterLegendType>(_RasterLegend_QNAME,
				RasterLegendType.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}{@link LabelLegendType }
	 * {@code >}
	 * 
	 */
	...
	public JAXBElement<LabelLegendType> createLabelLegend(LabelLegendType value) {
		return new JAXBElement<LabelLegendType>(_LabelLegend_QNAME,
				LabelLegendType.class, null, value);
	}
