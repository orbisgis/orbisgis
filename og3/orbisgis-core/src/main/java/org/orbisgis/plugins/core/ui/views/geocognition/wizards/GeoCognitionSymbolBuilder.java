...
import org.orbisgis.plugins.core.ui.editorViews.toc.actions.cui.SymbolEditorListener;
import org.orbisgis.plugins.core.ui.editorViews.toc.actions.cui.SymbolFilter;
import org.orbisgis.plugins.core.ui.editorViews.toc.actions.cui.SymbolListModel;
import org.orbisgis.plugins.core.ui.editorViews.toc.actions.cui.components.Canvas;
import org.orbisgis.plugins.core.ui.editorViews.toc.actions.cui.components.SymbolSelection;
...
import org.orbisgis.plugins.core.ui.editorViews.toc.actions.cui.legends.StandardSymbolFilter;
...
public class GeoCognitionSymbolBuilder extends JPanel implements UIPanel,
	...
	public GeoCognitionSymbolBuilder() {
		initComponents();
	...
	private ISymbolEditor getEditor(Symbol selectedSymbol) {
		ISymbolEditor[] editors = EPLegendHelper.getSymbolPanels();
	...
	private void jButtonSymbolAddActionPerformed(ActionEvent evt) {
		...
		for (Symbol availableSymbol : availableSymbols) {
			...
			if (symbolFilter != null) {
				...
				symbolFilter = new StandardSymbolFilter();
			}
