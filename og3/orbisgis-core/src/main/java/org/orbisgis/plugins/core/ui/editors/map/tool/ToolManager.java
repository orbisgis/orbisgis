 ...
 */
package org.orbisgis.plugins.core.ui.editors.map.tool;
...
import org.orbisgis.plugins.core.layerModel.LayerListenerAdapter;
...
import org.orbisgis.plugins.core.map.TransformListener;
...
import org.orbisgis.plugins.core.ui.editors.map.tools.ToolUtilities;
...
public class ToolManager extends MouseAdapter implements MouseMotionListener {
	...
	private void configureMenu() {
		if (ToolUtilities.isResctritedPopup(currentTool)) {
			...
			JComponent[] menus = wbContext.getWorkbench().getFrame()
					.getMenuMapTreePopup().getJMenus();
