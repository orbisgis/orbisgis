...
class GeometryConversionUtilsTest extends GeometryUtilsTest {
    ...
    @Test
    void asType3DGeomToWK() {
        def geom = [4, 5.0, 6] as Point
        geom.SRID = 4326
        def wkt = "POINT (4 5)"
        def ewkt = "SRID=4326;POINT Z (4 5 6)"
        def wkb = toByteArray("010100000000000000000010400000000000001440")
        assert geom as WKT == wkt
        assert geom as EWKT == ewkt
        assert geom as WKB == wkb

        geom = [[4.0, 2, 8], [2, 3, 7], [3.0, 5.0, 6]] as LineString
        geom.SRID = 4326
        wkt = "LINESTRING (4 2, 2 3, 3 5)"
        ewkt = "SRID=4326;LINESTRING Z (4 2 8, 2 3 7, 3 5 6)"
        wkb = toByteArray("0102000000030000000000000000001040000000000000004000000000000000" +
                "40000000000000084000000000000008400000000000001440")
        assert geom as WKT == wkt
        assert geom as EWKT == ewkt
        ...
        geom = [[[0,0,8], [3,0,6], [3,2,4], [1,3,2], [0,0,0]]] as Polygon
        geom.SRID = 4326
        wkt = "POLYGON ((0 0, 3 0, 3 2, 1 3, 0 0))"
        ewkt = "SRID=4326;POLYGON Z ((0 0 8, 3 0 6, 3 2 4, 1 3 2, 0 0 0))"
        wkb = toByteArray("01030000000100000005000000000000000000000000000000000000000000000000000" +
                "840000000000000000000000000000008400000000000000040000000000000f03f0000000000000" +
                "84000000000000000000000000000000000")
        assert geom as WKT == wkt
        ...
        geom = [[[0,0,8], [3,0,7], [3,2,6], [1,3,5], [0,0,4]], [[1,1,1], [2,1,2], [2,2,2], [1,1,1]]] as Polygon
        geom.SRID = 4326
        wkt = "POLYGON ((0 0, 3 0, 3 2, 1 3, 0 0), (1 1, 2 1, 2 2, 1 1))"
        ewkt = "SRID=4326;POLYGON Z ((0 0 8, 3 0 7, 3 2 6, 1 3 5, 0 0 4), (1 1 1, 2 1 2, 2 2 2, 1 1 1))"
        wkb = toByteArray("01030000000200000005000000000000000000000000000000000000000000000000000" +
                "840000000000000000000000000000008400000000000000040000000000000f03f0000000000000" +
                "8400000000000000000000000000000000004000000000000000000f03f000000000000f03f" +
                "0000000000000040000000000000f03f00000000000000400000000000000040000000000000f03f000000000000f03f")
        ...
        geom = [[0,0,8], [3,0,8], [3,2,8], [1,3,8]] as MultiPoint
        geom.SRID = 4326
        wkt = "MULTIPOINT ((0 0), (3 0), (3 2), (1 3))"
        ewkt = "SRID=4326;MULTIPOINT Z ((0 0 8), (3 0 8), (3 2 8), (1 3 8))"
        wkb = toByteArray("01040000000400000001010000000000000000000000000000000000000001010000000000000000000" +
                "84000000000000000000101000000000000000000084000000000000000400101000000000000000000f03f" +
                "0000000000000840")
        assert geom as WKT == wkt
        ...
        geom = [[[0,0,8], [3,0,8]], [[3,2,8], [1,3,8]]] as MultiLineString
        geom.SRID = 4326
        wkt = "MULTILINESTRING ((0 0, 3 0), (3 2, 1 3))"
        ewkt = "SRID=4326;MULTILINESTRING Z ((0 0 8, 3 0 8), (3 2 8, 1 3 8))"
        wkb = toByteArray("010500000002000000010200000002000000000000000000000000000000000000000000000" +
                "0000008400000000000000000010200000002000000000000000000084000000000000000400000000000" +
                "00f03f0000000000000840")
        assert geom as WKT == wkt
        ...
        geom = [[[[0,0,8], [3,0,6], [3,2,4], [1,3,2], [0,0,4]]], [[[10, 10, 1], [11, 10, 2], [11, 11, 3], [10, 10, 4]]]] as MultiPolygon
        geom.SRID = 4326
        wkt = "MULTIPOLYGON (((0 0, 3 0, 3 2, 1 3, 0 0)), ((10 10, 11 10, 11 11, 10 10)))"
        ewkt = "SRID=4326;MULTIPOLYGON Z (((0 0 8, 3 0 6, 3 2 4, 1 3 2, 0 0 4)), ((10 10 1, 11 10 2, 11 11 3, 10 10 4)))"
        wkb = toByteArray("0106000000020000000103000000010000000500000000000000000000000000000000000000000" +
                "0000000000840000000000000000000000000000008400000000000000040000000000000f03f000000000000" +
                "08400000000000000000000000000000000001030000000100000004000000000000000000244000000000000" +
                "02440000000000000264000000000000024400000000000002640000000000000264000000000000024400000" +
        ...
        geom = [[[[0,0,8], [3,0,6], [3,2,4], [1,3,2], [0,0,4]], [[1,1,1], [2,1,2], [2,2,2], [1,1,1]]], [[[10, 10, 1], [11, 10, 2], [11, 11, 3], [10, 10, 4]]]] as MultiPolygon
        geom.SRID = 4326
        wkt = "MULTIPOLYGON (((0 0, 3 0, 3 2, 1 3, 0 0), (1 1, 2 1, 2 2, 1 1)), ((10 10, 11 10, 11 11, 10 10)))"
        ewkt = "SRID=4326;MULTIPOLYGON Z (((0 0 8, 3 0 6, 3 2 4, 1 3 2, 0 0 4), (1 1 1, 2 1 2, 2 2 2, 1 1 1)), ((10 10 1, 11 10 2, 11 11 3, 10 10 4)))"
        wkb = toByteArray("010600000002000000010300000002000000050000000000000000000000000000000000000" +
                "00000000000000840000000000000000000000000000008400000000000000040000000000000f03f00000000" +
                "000008400000000000000000000000000000000004000000000000000000f03f000000000000f03f000000000" +
                "0000040000000000000f03f00000000000000400000000000000040000000000000f03f000000000000f03f01" +
    ...
    @Test
    void asType4DGeomToWK() {
        def geom = [4, 5.0, 6, 7] as Point
        geom.SRID = 4326
        def wkt = "POINT (4 5)"
        def ewkt = "SRID=4326;POINT ZM (4 5 6 7)"
        def wkb = toByteArray("010100000000000000000010400000000000001440")
        assert geom as WKT == wkt
        assert geom as EWKT == ewkt
        assert geom as WKB == wkb

        geom = [[4.0, 2, 8, 5], [2, 3, 7, 6], [3.0, 5.0, 6, 7]] as LineString
        geom.SRID = 4326
        wkt = "LINESTRING (4 2, 2 3, 3 5)"
        ewkt = "SRID=4326;LINESTRING ZM (4 2 8 5, 2 3 7 6, 3 5 6 7)"
        wkb = toByteArray("0102000000030000000000000000001040000000000000004000000000000000" +
                "40000000000000084000000000000008400000000000001440")
        assert geom as WKT == wkt
        assert geom as EWKT == ewkt
        ...
        geom = [[[0,0,8,0], [3,0,6,1], [3,2,4,1], [1,3,2,0], [0,0,0,1]]] as Polygon
        geom.SRID = 4326
        wkt = "POLYGON ((0 0, 3 0, 3 2, 1 3, 0 0))"
        ewkt = "SRID=4326;POLYGON ZM ((0 0 8 0, 3 0 6 1, 3 2 4 1, 1 3 2 0, 0 0 0 1))"
        wkb = toByteArray("01030000000100000005000000000000000000000000000000000000000000000000000" +
                "840000000000000000000000000000008400000000000000040000000000000f03f0000000000000" +
                "84000000000000000000000000000000000")
        assert geom as WKT == wkt
        ...
        geom = [[[0,0,8,0], [3,0,7,1], [3,2,6,1], [1,3,5,0], [0,0,4,1]], [[1,1,1,5], [2,1,2,4], [2,2,2,3], [1,1,1,2]]] as Polygon
        geom.SRID = 4326
        wkt = "POLYGON ((0 0, 3 0, 3 2, 1 3, 0 0), (1 1, 2 1, 2 2, 1 1))"
        ewkt = "SRID=4326;POLYGON ZM ((0 0 8 0, 3 0 7 1, 3 2 6 1, 1 3 5 0, 0 0 4 1), (1 1 1 5, 2 1 2 4, 2 2 2 3, 1 1 1 2))"
        wkb = toByteArray("01030000000200000005000000000000000000000000000000000000000000000000000" +
                "840000000000000000000000000000008400000000000000040000000000000f03f0000000000000" +
                "8400000000000000000000000000000000004000000000000000000f03f000000000000f03f" +
                "0000000000000040000000000000f03f00000000000000400000000000000040000000000000f03f000000000000f03f")
        ...
        geom = [[0,0,8,0], [3,0,8,0], [3,2,8,0], [1,3,8,0]] as MultiPoint
        geom.SRID = 4326
        wkt = "MULTIPOINT ((0 0), (3 0), (3 2), (1 3))"
        ewkt = "SRID=4326;MULTIPOINT ZM ((0 0 8 0), (3 0 8 0), (3 2 8 0), (1 3 8 0))"
        wkb = toByteArray("01040000000400000001010000000000000000000000000000000000000001010000000000000000000" +
                "84000000000000000000101000000000000000000084000000000000000400101000000000000000000f03f" +
                "0000000000000840")
        assert geom as WKT == wkt
        ...
        geom = [[[0,0,8,0], [3,0,8,0]], [[3,2,8,0], [1,3,8,0]]] as MultiLineString
        geom.SRID = 4326
        wkt = "MULTILINESTRING ((0 0, 3 0), (3 2, 1 3))"
        ewkt = "SRID=4326;MULTILINESTRING ZM ((0 0 8 0, 3 0 8 0), (3 2 8 0, 1 3 8 0))"
        wkb = toByteArray("010500000002000000010200000002000000000000000000000000000000000000000000000" +
                "0000008400000000000000000010200000002000000000000000000084000000000000000400000000000" +
                "00f03f0000000000000840")
        assert geom as WKT == wkt
        ...
        geom = [[[[0,0,8,0], [3,0,6,1], [3,2,4,1], [1,3,2,0], [0,0,4,1]]], [[[10, 10, 1, 4], [11, 10, 2, 3], [11, 11, 3, 2], [10, 10, 4, 1]]]] as MultiPolygon
        geom.SRID = 4326
        wkt = "MULTIPOLYGON (((0 0, 3 0, 3 2, 1 3, 0 0)), ((10 10, 11 10, 11 11, 10 10)))"
        ewkt = "SRID=4326;MULTIPOLYGON ZM (((0 0 8 0, 3 0 6 1, 3 2 4 1, 1 3 2 0, 0 0 4 1)), ((10 10 1 4, 11 10 2 3, 11 11 3 2, 10 10 4 1)))"
        wkb = toByteArray("0106000000020000000103000000010000000500000000000000000000000000000000000000000" +
                "0000000000840000000000000000000000000000008400000000000000040000000000000f03f000000000000" +
                "08400000000000000000000000000000000001030000000100000004000000000000000000244000000000000" +
                "02440000000000000264000000000000024400000000000002640000000000000264000000000000024400000" +
        ...
        geom = [[[[0,0,8,0], [3,0,6,1], [3,2,4,1], [1,3,2,0], [0,0,4,1]], [[1,1,1,5], [2,1,2,4], [2,2,2,3], [1,1,1,2]]], [[[10, 10, 1, 4], [11, 10, 2, 3], [11, 11, 3, 2], [10, 10, 4, 1]]]] as MultiPolygon
        geom.SRID = 4326
        wkt = "MULTIPOLYGON (((0 0, 3 0, 3 2, 1 3, 0 0), (1 1, 2 1, 2 2, 1 1)), ((10 10, 11 10, 11 11, 10 10)))"
        ewkt = "SRID=4326;MULTIPOLYGON ZM (((0 0 8 0, 3 0 6 1, 3 2 4 1, 1 3 2 0, 0 0 4 1), (1 1 1 5, 2 1 2 4, 2 2 2 3, 1 1 1 2)), ((10 10 1 4, 11 10 2 3, 11 11 3 2, 10 10 4 1)))"
        wkb = toByteArray("010600000002000000010300000002000000050000000000000000000000000000000000000" +
                "00000000000000840000000000000000000000000000008400000000000000040000000000000f03f00000000" +
                "000008400000000000000000000000000000000004000000000000000000f03f000000000000f03f000000000" +
                "0000040000000000000f03f00000000000000400000000000000040000000000000f03f000000000000f03f01" +
