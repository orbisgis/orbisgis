...
public class test2 {
	...
	// propri�t�s de chaque batiments
	...
	// extrait les donn�es du fichier shapfile, recupere les batiments pour les
	// mettres dans
	// un HashMap ayant pour cl� l'id�e du batiment et pour valeur un arraylist
	// contenant les donn�es du batiment
	public static HashMap<String, ArrayList> recuptab(String URI)
		...
		// entr�es des noms dans la hashmap
	...
	//calcul un angle pour une facade donn�e d'un batiment
	...
	public static void donnerStats(int x, int y) {
		...
		System.out
				.println("pourcentage d'occupation du territoire au coordonn�es "
						+ x
						+ " et "
						+ y
						+ " est de "
