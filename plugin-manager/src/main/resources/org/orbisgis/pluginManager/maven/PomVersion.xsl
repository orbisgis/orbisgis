...
<xsl:stylesheet version="1.0" xmlns:m="http://maven.apache.org/POM/4.0.0"
	...
	<xsl:variable name="parent-version">1.2.1</xsl:variable>
	<xsl:variable name="commons-version">1.0.1</xsl:variable>
	<xsl:variable name="gdms-version">1.2.0</xsl:variable>
	<xsl:variable name="grap-version">1.1.1</xsl:variable>
	<xsl:variable name="h2-version">1.0.1</xsl:variable>
	<xsl:variable name="core-version">1.1.2</xsl:variable>
	<xsl:variable name="core-ui-version">1.2.1</xsl:variable>
	<xsl:variable name="games-version">1.0.0</xsl:variable>
	<xsl:variable name="processing-plugin-version">1.0.1</xsl:variable>
	<xsl:variable name="urbsat-version">1.0.2</xsl:variable>
	<xsl:variable name="plugin-manager-version">1.1.1</xsl:variable>
	<xsl:variable name="processing-version">1.1.2</xsl:variable>
	<xsl:variable name="sif-version">1.0.2</xsl:variable>
...
</xsl:stylesheet>>>>>>>> .merge-right.r5478
