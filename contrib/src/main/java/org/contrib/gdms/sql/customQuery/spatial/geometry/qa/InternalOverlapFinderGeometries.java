 ...
 */
package org.contrib.gdms.sql.customQuery.spatial.geometry.qa;
...
public class InternalOverlapFinderGeometries implements CustomQuery {
	...
	public ObjectDriver evaluate(DataSourceFactory dsf, DataSource[] tables,
		...
		try {
			...
			DataSource dsResult = new FeatureCollectionDatasourceAdapter(result);
					
			final ObjectMemoryDriver driver = new ObjectMemoryDriver(dsResult);
