...
public class ExportTest extends AbstractDBTest {
        ...
        private void testSHP2H22PostgreSQL2SHP(String script, String orderField,
                ...
                script += "CALL register('h2','', '0', '"
                        + SQLBaseTest.internalData + "backup/h2landcoverfromshp',"
                ...
                script += "CALL register('" + SQLBaseTest.internalData + "backup/landcoverfrompg.shp', 'res');";
...
//	}
        ...
        public void testSHP3D2H2() throws Exception {
                ...
                script += "create table res2 as select * from landcover2000;";
                check(script, "gid");
        }
