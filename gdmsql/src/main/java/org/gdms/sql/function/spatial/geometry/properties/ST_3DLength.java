...
public class ST_3DLength extends AbstractSpatialPropertyFunction {
        ...
        @Override
        protected Value evaluateResult(SQLDataSourceFactory dsf, Value[] args) throws FunctionException {
        ...
        public String getDescription() {
                return "Return the 3D length of a geometry.";
        }
        ...
        public String getSqlOrder() {
                return "select ST_3DLength(the_geom) from myTable;";
        }
}
