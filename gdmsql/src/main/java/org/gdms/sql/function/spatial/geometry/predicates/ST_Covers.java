...
/**
 * Return true if the geometry A covers the geometry B
 */
public final class ST_Covers extends AbstractSpatialPredicateFunction implements SpatialIndexedFunction {
        ...
        public Value evaluateResult(SQLDataSourceFactory dsf, Value[] args) throws FunctionException {
                ...
                return ValueFactory.createValue(geom1.covers(geom2));
        }
        ...
        public String getDescription() {
                return "Return true if the geometry A covers the geometry B";
        }
