...
/**
 * Return the resulting value of the first argument raised to the power of the second argument.
 */
public final class Power extends AbstractScalarMathFunction {
        ...
        public String getDescription() {
                return "Return the resulting value of the first argument raised to the power of the second argument.";
        }
        ...
        public FunctionSignature[] getFunctionSignatures() {
                return new FunctionSignature[] {
                  new BasicFunctionSignature(Type.DOUBLE, new ScalarArgument[] {
