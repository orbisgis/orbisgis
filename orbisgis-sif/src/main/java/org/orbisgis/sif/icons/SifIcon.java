...
public final class SifIcon {
    ...
    private static final ImageIcon ORBISGIS_MISSING_ICON = new ImageIcon(SifIcon.class.getResource("remove.png")); /*!< Icon displayed when the requested icon is not found */
    
    private static final Logger LOG = Logger.getLogger(SifIcon.class); /*!< Logger of SifIcon */
    ...
    public static ImageIcon getIcon(String iconName) {
        if(!loadedIcons.containsKey(iconName)) {
            ...
            URL url = SifIcon.class.getResource(iconName+".png");
            if(url!=null) {
