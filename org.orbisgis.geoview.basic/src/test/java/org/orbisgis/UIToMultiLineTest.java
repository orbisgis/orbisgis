...
public class UIToMultiLineTest extends UITest {
	...
	protected void setUp() throws Exception {
		...
		// Following line of code should be uncommented !
		// dsf.getSourceManager().register("ds2",
		// "select pk, ToMultiLine(geom) from ds1;");
	}
	...
	public void testDragAndDropAfterAToMultiLine() throws Exception {
		// Following 3 lines of code should be uncommented !

		// ILayer myNewLayer = LayerFactory.createLayer("ds2");
