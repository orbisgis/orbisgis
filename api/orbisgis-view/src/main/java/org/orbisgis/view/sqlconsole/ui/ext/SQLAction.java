 ...
 */
public interface SQLAction extends ActionFactoryService<org.orbisgis.view.sqlconsole.ui.ext.SQLConsoleEditor> {
    // Action, MENU IDs
    ...
    public static final String A_UNCOMMENT = "M_UNCOMMENT";
