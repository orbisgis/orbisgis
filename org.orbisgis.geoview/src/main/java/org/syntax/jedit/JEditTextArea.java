...
public class JEditTextArea extends JComponent
{
	...
	public JEditTextArea(TextAreaDefaults defaults)
	{
        ...
        // added by Michael MICHAUD on 21 august 2004
    ...
    // Added by Michael MICHAUD on 21 august 2004 to handle MouseWheel
    class MouseWheelHandler implements MouseWheelListener {
        public void mouseWheelMoved(MouseWheelEvent e) 
		{
            if(vertical != null && visibleLines != 0)
            {
                int newFirstLine = firstLine + e.getWheelRotation();
                if (newFirstLine > (getLineCount()-getVisibleLines())) {
                    newFirstLine = getLineCount()-getVisibleLines();
                }
