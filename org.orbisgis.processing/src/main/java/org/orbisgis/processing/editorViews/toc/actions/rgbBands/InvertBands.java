 ...
 */
package org.orbisgis.processing.editorViews.toc.actions.rgbBands;
...
public class InvertBands implements
	...
	public void execute(MapContext mapContext, ILayer layer) {
		...
		try {
			...
			if (UIFactory.showDialog(mip)) {
				String codeBands = bands.get(mip.getInput("red")) + bands.get(mip.getInput("green"))
	...
	private void init() {
		...
		mip.addInput("red", "Red", null, new ComboBoxChoice(bands.keySet()
				.toArray(new String[0])));
		mip.addInput("green", "Green", null, new ComboBoxChoice(bands.keySet()
				.toArray(new String[0])));
		mip.addInput("blue", "Blue", null, new ComboBoxChoice(bands.keySet()
				.toArray(new String[0])));
