...
/**
 * Open a H2GIS DataStore with the given closure which will be delegated to DataStoreParams.
 * @param cl Closure delegated to DataStoreParams.
 * @return An H2GIS DataStore.
 */
static JDBCDataStore open(@DelegatesTo(H2GISDataStoreParams) Closure cl) {
    def params = new H2GISDataStoreParams()
